...
Step 5: Verify
Step 6: Exit VM
Vagrant Lifecycle Commands (Daily Admin Use)


## LAB 1 – First Vagrant VM (Beginner)
### Goal
...
# add a private network and ip address 192.168.56.111
config.vm.network "private_network", ip: "192.168.56.111"
```
...
``` 
# Open the Vagrantfile and add the forwarded_port port 80
vim Vagrantfile

# Add the forwarded_port line to the file.
```




## LAB 3 – Web Server with Networking
